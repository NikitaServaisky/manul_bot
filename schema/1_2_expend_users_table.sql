...
ALTER TABLE users ADD COLUMN IF NOT EXISTS base_salary_rate DECIMAL(10, 2) DEFAULT 0.00; -- Rate (per hour/day/month)
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS bank_branch VARCHAR(20);
